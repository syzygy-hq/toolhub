...
export const tools: ToolMeta[] = [
  ...
  },
  {
    ...
    description: "Grab any YouTube video's thumbnail in every available resolution.",
    category: "Video & Audio",
  ...
  },
  {
    ...
    description: "Turn a YouTube video and a timestamp into a shareable link that jumps right there.",
    category: "Video & Audio",
  ...
  },
  {
    slug: "video-trimmer",
    name: "Video Trimmer",
    description: "Cut a video down to a start/end range and download the clip.",
    category: "Video & Audio",
  ...
  },
  {
    slug: "gif-maker",
    name: "GIF Maker",
    description: "Turn a clip from any video into a looping GIF, with fps and size controls.",
    category: "Video & Audio",
  ...
  },
  {
    ...
    description: "Convert audio between MP3, WAV, and OGG.",
    category: "Video & Audio",
  ...
  },
  {
    ...
    description: "Shrink a video's file size with an adjustable quality/size tradeoff.",
    category: "Video & Audio",
  ...
  {
    slug: "audio-trimmer",
    name: "Audio Trimmer & Merger",
    description: "Trim a single audio clip, or merge several audio files into one.",
    category: "Video & Audio",
